...
export default function Administradores() {
    ...
    $(document).ready( function () {
       let tablaAdministrador = $('.table').DataTable({
            data: dataTable,
            "columDefs":[{
                "searchable":true,
                "orderable":true,
        ...
        tablaAdministrador.on("order.dt search.dt", function(){
            tablaAdministrador.column(0,{search:"applied", order:"applied"})
    ...
    return(
        <div className="content-wrapper" style={{minHeight:"494px"}}>
           ...
           <CrearAdministradores/>
            {/*=======================
            Ventana modal para la edicion de usuarios
            ========================= */}
